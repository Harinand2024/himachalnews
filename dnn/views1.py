...
# -------------end-ad-manage-meny--------------    
    ...
    data={
            ...
            # 'grouped_postsdata3': grouped_postsdata3,
            'usernews': user_news,
            'profiles': profiles,
...
def newsdetails(request,slug):
    ...
    seo_details_page = seo_optimization.objects.filter(pageslug__iexact=slug, status='active').first()
    if seo_details_page is None:
        seo_details_page = get_object_or_404(NewsPost, slug=slug, status='active')

    if isinstance(seo_details_page, seo_optimization):
        print("✅ Data came from seo_optimization ")
    elif isinstance(seo_details_page, NewsPost):
        print("✅ Data came from NewsPost")
...
# -------------end-ad-manage-meny--------------    
    ...
    data={
            'seo_details_page':seo_details_page,
